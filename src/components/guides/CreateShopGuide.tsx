...
const CreateShopGuide = () => {
  ...
  const p = "https://youtu.be/r1VgPILjMjc";
  ...
  return (
    <section>
      ...
      <Text>
        On mobile devices, click the plus icon (+) located at the top right just
        below the navigation bar to start the shop creation process. On larger
        screens, click the 'Add Product' button.
      </Text>
      <Text>
        A 'Choose Shop' modal will appear. If you already have a shop, you can
        select it from the list. If you don’t have a shop yet, follow these
        steps to create one:
      </Text>
      <Text>
        Click on{" "}
        <Link route="/mart/shops/new">'create a new shop instead'</Link>
        {"  "} at the top of the modal and you'll be directed to a page to input
        your shop's details
      </Text>
      <Text>Choose an image to represent your shop</Text>
      <Text>
        Input the name and shop type (e.g., clothing). Your shop can have more
        than one type, allowing you to sell different items at once.
      </Text>
      <Text>
        State the location of your shop. Potential buyers often make purchasing
        decisions based on the shop's location.
      </Text>
      <Text>
        Finally, save the information and WAIT for the shop to be created. If
        you navigate to other pages, you may interfere with the creation
        process.
      </Text>
      <Text>
